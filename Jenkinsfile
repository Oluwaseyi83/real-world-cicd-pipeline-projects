...
pipeline {
    ...
    stage('SonarQube Inspection') {
        steps {
            withSonarQubeEnv('SonarQube') { 
                ...
                -Dsonar.host.url=http://172.31.12.1:9000 \
  ...
  post {
    always {
        ...
        slackSend channel: '#cicd-pipeline-project-oluwaseyios', //update and provide your channel name
